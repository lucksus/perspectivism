...
const languages = {
    'social-context': {
        bundle: 'https://github.com/juntofoundation/Social-Context/releases/download/0.0.4/bundle.js',
        dna: 'https://github.com/juntofoundation/Social-Context/releases/download/0.0.4/social-context.dna'
    },
    'agent-profiles': {
